import 'package:bcc_connect_app/API%20Model%20And%20Service%20(BCC_Connections)/connectionsbccModel.dart';
                  ...
                  CircleAvatar(
                   /* backgroundImage: photoUrl.isNotEmpty
                        ? NetworkImage(photoUrl)
                            as ImageProvider // For network images
                        : Icon(
                            Icons.person,
                            size: 35,
                          ) as ImageProvider,*/ // For local images
                    radius: 30,
                  ),
                  Text(
                    /*userName*/ 'Welcome',
