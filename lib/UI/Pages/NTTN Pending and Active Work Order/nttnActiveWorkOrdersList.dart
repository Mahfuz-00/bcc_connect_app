...
import 'package:bcc_connect_app/UI/Pages/NTTN%20Pending%20and%20Active%20Work%20Order/nttnPendingWorkOrdersList.dart';
import 'package:bcc_connect_app/UI/Widgets/nttnWorkOrderActiveDetails.dart';
...
/// The [NTTNActiveWorkOrderListUI] widget displays a list of active
...
class NTTNActiveWorkOrderListUI extends StatefulWidget {
  final bool shouldRefresh;

  const NTTNActiveWorkOrderListUI({Key? key, this.shouldRefresh = false})
      : super(key: key);

  @override
  State<NTTNActiveWorkOrderListUI> createState() =>
      _NTTNActiveWorkOrderListUIState();
}

class _NTTNActiveWorkOrderListUIState
    extends State<NTTNActiveWorkOrderListUI> {
